...
namespace SCSScript
{
	class Logger : public WriterASCII,public Helpers::Singleton<Logger>
	{
	private:
		bool WriteStartHeader(const String& prjStr="");
		bool WriteEndHeader();
	...
	public:
		...
		bool Start(const String& strFile,const String& prjStr);
		void FakeInit() {};
	};
}

#define LOG	SCSScript::Logger::Instance()
